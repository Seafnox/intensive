    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-6 left_block">
                ...
                <p class="footer"><a href="http://imsider.justclick.ru/order/intensiv8_VIP/?tag=<?=$tag;?>" target="_blank" class="btn get_plan_big">получить план действий</a></p>
            </div>
            <div class="col-xs-6 right_block">
                <header>
                    <h2>Интенсив + Бизнес под ключ</h2>
                    <p class="price">21 900<span class="ruble">e</span></p>
                </header>
              <ul>
                    <li class="first">
                ...
                <p class="footer"><a href="http://imsider.justclick.ru/order/intensiv8_VIP-business_pod_kluch/?tag=<?=$tag;?>" target="_blank" class="btn open_bus">открыть бизнес</a></p>
            </div>
            <div class="metric">
