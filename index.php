...
<div id="preload">
	...
	<!-- HiConversion tracking code -->
	<script type="text/javascript">(window.Image ? (new Image()) : document.createElement('img')).src = location.protocol + '//vk.com/rtrg?r=rg2sU0RMfynYkQVtRKM4jzmLAhQWPRoPGDu6CNL3gLCH4hS5clZD1*4fbCZZrIZBQgouM9O0AaXjytreppw0NxunGH5aS6fAlY3zoecQd5533zEJ*Yf4NvoDpcFp/sDAIuYwXOe3yHffLbuWNCDa7bC569S3HvHNzfs81JcOBTE-';</script>
	<!-- / HiConversion tracking code -->
...
<header id="header">
	<div class="container">
		<div class="preheader">
		  ...
		  <p>Онлайн-интенсив: мастер-классы и тренинги от  бизнесмена-миллионера</p>
		</div>
	  <div class="page-header">
      <h1><span>Получи пошаговый план <br>для открытия своего интернет-магазина
с доходом </span>От 100 000 рублей за 3 дня<span>с 1 по 3 апреля 2014</span></h1></div>
	  <div class="preheader">
		  <!--p class="text-center">Я открою новый бизнес за три дня. В прямом эфире. Вместе с вами. <em>(Н. Федоткин)</em></p-->
		</div>
		<p><a href="" class="btn flat dark_blue">Узнать подробности</a></p>
	</div>
...
<section id="second">
	<div class="container">
		<div class="embeded width850">
			<iframe src="http://www.youtube.com/embed/WnAuONzdujw?rel=0" height="480" width="853" allowfullscreen="" frameborder="0"></iframe>
		</div>
	</div>
</section>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-6 left_block">
                <header>
                    <h2>Интенсив</h2>
                    <p class="price">5 500<span class="ruble">e</span></p>
                </header>
                <ul>
                ...
                <p class="footer"><a href="http://imsider.justclick.ru/order/intensiv8_VIP/?tag=intensive.imsider.ru<?=$ad;?>" target="_blank" class="btn get_plan_big">получить план действий</a></p>
            </div>
            <div class="col-xs-6 right_block">
                <header>
                    <h2>Интенсив + Бизнес под ключ</h2>
                    <p class="price">16 900<span class="ruble">e</span></p>
                </header>
              <ul>
                    <li class="first">
                        <p><strong>Все, что входит в Интенсив</strong></p></li>
                    <li class="first">
                        <p><strong>Участие в тренинге <a href="http://business.imsider.ru/?ad=109764" target="_blank">Бизнес под ключ</a> (тариф Новичок):</strong></p></li>
                ...
                <p class="footer"><a href="http://imsider.justclick.ru/order/intensiv8_VIP-business_pod_kluch/?tag=intensive.imsider.ru<?=$ad;?>" target="_blank" class="btn open_bus">открыть бизнес</a></p>
            </div>
            <div class="metric">
...
<section id="seventh">
	<div class="container">
		...
		<div class="embeded width850">
			<iframe width="853" height="480" src="//www.youtube.com/embed/gnU1LHA8Dgg?rel=0" frameborder="0" allowfullscreen></iframe>
		</div>
	</div>
</section>
<section id="eighth">
...
<section id="eleven">
	<div class="container">
		...
		<div class="embeded width850">
		  <iframe width="853" height="480" src="//www.youtube.com/embed/X6NPu3eABWA?rel=0" frameborder="0" allowfullscreen></iframe>
	  </div>
	  </div>
	</div>
</section>
...
<section id="fourteen">
	<div class="container">
		...
		<div class="embeded width850">
			<iframe width="853" height="480" src="//www.youtube.com/embed/vIReW7icktI?rel=0" frameborder="0" allowfullscreen></iframe>
		</div>
	</div>
</section>
<section id="fifteen">
	...
	<div class="container">
		...
		<div class="row video">
			<div class="col-xs-8 embeded">
				<iframe width="625" height="380" src="//www.youtube.com/embed/AW-Zebt7c0M?rel=0" frameborder="0" allowfullscreen></iframe>
			</div>
			<div class="col-xs-4">
		...
		<div class="row video">
			<div class="col-xs-8 embeded">
				<iframe width="625" height="380" src="//www.youtube.com/embed/5JMGDdFlHLg?rel=0" frameborder="0" allowfullscreen></iframe>
			</div>
			<div class="col-xs-4">
...
<section id="nineteen">
	<div class="container">
		...
		<div class="embeded">
			<iframe width="853" height="480" src="//www.youtube.com/embed/hTF3e68Gbhk?rel=0" frameborder="0" allowfullscreen></iframe>
		</div>
	</div>
</section>
<section id="twenty">
