...
<header id="header">
	<div class="container">
	  ...
	  <div class="page-header">
		<h1>От 100 000 до 300 000 рублей <span>прибыли в интернет-магазине. С 27 по 29 января</span></h1></div>
	  <div class="preheader">
		  <p>&nbsp;</p>
...
<section id="second">
	<div class="container">
		<div class="embeded width850">
			<iframe width="853" height="480" src="//www.youtube.com/embed/WnAuONzdujw" frameborder="0" allowfullscreen></iframe>
		</div>
	</div>
</section>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-6 left_block">
                ...
                <p class="footer"><a href="http://imsider.justclick.ru/order/intensiv6_VIP/?tag=intensive.imsider.ru<?=$ad;?>" target="_blank" class="btn get_plan_big">получить план действий</a></p>
            </div>
            <div class="col-xs-6 right_block">
                <header>
                    <h2>VIP + Реалити</h2>
                    <p class="price">12 900<span class="ruble">e</span></p>
                </header>
                <ul>
                    <li class="first">
                        <p><strong>Все, что входит в VIP</strong></p></li>
                    <li class="first">
                        <p><strong>Участие в <a href="http://reality300.imsider.ru/?ad=92492" target="_blank">Реалити-4</a> (тариф Предприниматель):</strong></p></li>
                    ...
                    <li><p>Доступ к шаблонам дизайна
                            и рекламы, которыми будем пользоваться мы</p></li>
                </ul>
                <div class="dashed"></div>
                <p class="goal">Цель +300 000</p>
                <p class="footer"><a href="http://imsider.justclick.ru/order/intensiv6_VIP-Reality4/?tag=intensive.imsider.ru<?=$ad;?>" target="_blank" class="btn open_bus">открыть бизнес</a></p>
            </div>
